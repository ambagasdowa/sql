USE [integraapp]
GO
/****** Object:  StoredProcedure [dbo].[sp_udsp_getBalanzaComprobacion]    Script Date: 21/04/2016 12:54:02 p.m. ******/
SET ANSI_NULLS ON
GO
...
/*===============================================================================
 ...
 Description    : fetch the Balanza for accounts and sub accounts from GLTran
