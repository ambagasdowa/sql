...
-- ================================================================================================================================== --
-- change this to be all dinamic	
		
	if @mode = 9
		begin
			
			select @Company as 'company',@bunit as 'bunit',@mode as 'mode',@user_id as 'user_id',@period_id as 'perid_unit'
...
--		delete sistemas.dbo.projections_cancelations where id = 41
		use sistemas
		
		select IDENT_CURRENT('sistemas.dbo.projections_cancelations') as 'lastInsertID'; 
		
		insert into sistemas.dbo.projections_cancelations (flota) values ('Espacial')
		
		select * from sistemas.dbo.projections_cancelations
		
		exec sp_desc projections_logs
		exec sp_desc projections_cancelations
