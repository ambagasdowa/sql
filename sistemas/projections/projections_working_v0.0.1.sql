...
---- ==================================================================================================================================================
	...
	declare closed_period_cursor cursor for
						...
						from 
								projections_view_closed_period_units 
						order by 
			...
			-- ===============================================================================================================
				print 'stack Query';
					if (
						...
						print @master_projections_closed_periods;
						...
						if DATEDIFF ( mm , @master_projections_closed_periods , (@current_year + '-' + @current_month + '-' + '01') ) = 0
							...
							begin
								...
								print 'are diff <> 1 : just valid if the offset is one month'
								print 'months are diff'
