...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		from 
				@indicators as logs 
			inner join bonampakdb.dbo.trafico_guia as rail on logs.id_area = rail.id_area and logs.no_viaje = rail.no_viaje and rail.status_guia <> 'B' and rail.prestamo <> 'P' and rail.tipo_doc = 2 
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		from 
				@indicators as logs 
			inner join tespecializadadb.dbo.trafico_guia as rail on logs.id_area = rail.id_area and logs.no_viaje = rail.no_viaje and rail.status_guia <> 'B' and rail.prestamo <> 'P' and rail.tipo_doc = 2 
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		from 
				@indicators as logs 
			inner join macuspanadb.dbo.trafico_guia as rail on logs.id_area = rail.id_area and logs.no_viaje = rail.no_viaje and rail.status_guia <> 'B' and rail.prestamo <> 'P' and rail.tipo_doc = 2 
...
-----------------------------
	...
	else if (@mode = 1) -- means insert because is a closed period
		begin
			if ( @bunit is null or @bunit ='' or @bunit = '0')
				begin
