...
select id_ruta,* from pruebasteisa.dbo.trafico_convenio where id_convenio = 6 and id_cliente = 1637

	select id_cliente,id_convenio,id_convenio,* from pruebasteisa.dbo.trafico_guia where num_guia = 'CU-120313'
