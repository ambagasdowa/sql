...
-- ==================================================================================================================== --
-- Grant permission to an user to execute the stores of MR
	use sistemas  
	GRANT EXECUTE ON "sistemas"."dbo"."reporter_sp_accounts" TO "integra"
...
--					('OF','Costos Operativos Fijos',null,null,null,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1',1),
--					('OV','Costos Operativos Variables',null,null,null,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1',1),
--					('MF','Costos Mantenimiento Fijos',null,null,null,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1',1),
--					('MV','Costos Mantenimiento Variables',null,null,null,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1',1),
--					('AD','Costos Administrativos',null,null,null,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1',1)
...
create view reporter_view_sp_xs4z_accounts
	...
	select 
			...
			"_key"
	from 
			openquery(local,'sistemas.dbo.reporter_sp_accounts')
