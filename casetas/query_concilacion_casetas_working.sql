	...
	insert into @iave_periods values	('375','Mayo 21 al 31','2016-05-21 00:00:00.000','2016-05-31 23:59:00.000','5','1','1',CURRENT_TIMESTAMP,'1'),
										...
										('395','Diciembre 11 al 20','2016-12-11 00:00:00.000','2016-12-20 23:59:00.000','5','1','1',CURRENT_TIMESTAMP,'1');
...
--	insert into sistemas.dbo.casetas_iave_periods values (1,'393','Noviembre 21 al 30','2016-11-21','2016-11-30','5','1',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'1');
	...
	if ((select options.switch from sistemas.dbo.casetas_options as options where options.option_name = 'next_period') = 1)
		...
		--truncate table sistemas.dbo.casetas_lis_full_conciliations
		--insert into sistemas.dbo.casetas_lis_full_conciliations 
			select * from @tollbooth_next_full where casetas_controls_files_id = '137' -- period_iave_id in ('394') and cia in ('TEICUA') and fecha_fin = '2016-12-10' -- and fecha_fin = '2016-12-10'
		;
...
--exec sistemas.dbo.sp_upt_tollbooth_zam_trips_records_conciliation

--select * from sistemas.dbo.casetas_lis_full_conciliations where casetas_controls_files_id = '137' --period_iave_id in ('394') and cia in ('TEICUA') and fecha_fin = '2016-12-10' --and fecha_fin = '2016-12-10'


--select * from sistemas.dbo.casetas_options
		-- select * from sistemas.dbo.casetas_iave_periods
