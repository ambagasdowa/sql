...
--					sistemas.dbo.casetas_iave_periods as iave
					sistemas.dbo.casetas_iave_periods_options as iave
					inner join
								(
									select 
		...
		with next_full as 
			(
				...
				insert into @tollbooth_next_full
					select * from next_full where liq_paso = 'S' and liq_tipo_pago = '1'  			
			end
		else 
		   begin
				insert into @tollbooth_next_full
		   	...
		   	select * from @tollbooth_next_full where period_iave_id = '414'
